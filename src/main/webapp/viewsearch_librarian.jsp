        ...
        <div class="article">
		 <table class="table table-striped">
					  ...
					  <%
                        ...
                        %>
	                        <form action="viewupdate_book" method="post">
								<tr>
								  ...
								  <td><button type="Update" class="btn btn-btncolorPaple" id="createbutton" name="st" Value="update">update</button>
								  	<input type="hidden" name="bookno" value="<%=list.get(0)%>">
								  </td>
								  <td><button type="Update" class="btn btn-btncolorPaple" id="createbutton" name="st" Value="delete">delete</button>
								  	<input type="hidden" name="bookno" value="<%=list.get(0)%>">
								  </td>
								</tr>
							</form>
