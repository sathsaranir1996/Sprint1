        ...
        <table class="table table-striped">
                    ...
                    <form action="queue" method="post">
								<tr>
								  ...
								  <td><button type="Delete" class="btn btn-btncolorbrown" id="createbutton" name="st" Value="remove">Remove from Queue</button>
								  	<input type="hidden" name="qid" value="<%=list.get(0)%>">
								  </td>
								</tr>
							</form>
						<%
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
           <form action="cartt" method="post">
            ...
            <li><a name="lk" value="cart">Book cart</a></li>
