        ...
        <table class="table table-striped">
                    ...
                    <form action="cart" method="post">
								<tr>
								  ...
								  <td><input type="hidden" name="auther" value="<%=list.get(2)%>"><%=list.get(2) %></td>
								  <td><input type="hidden" name="auther" value="<%=list.get(3)%>"><%=list.get(3) %></td>
								  <td><button type="Update" class="btn btn-btncolorPaple" id="createbutton" name="st" Value="addqueue">Booking</button>
								  	<input type="hidden" name="bookid" value="<%=list.get(4)%>">
								  </td>
								  <td><button type="Delete" class="btn btn-btncolorbrown" id="createbutton" name="st" Value="remove">Remove</button>
								  	<input type="hidden" name="id" value="<%=list.get(0)%>">
								  </td>
								  <td><button type="Update" class="btn btn-btncolorbrown" id="createbutton" name="st" Value="queue">Queue</button>
								</td>>
								</tr>
							</form>
						<%
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
           <form action="cartt" method="post">
            ...
            <li><a name="lk" value="profile">Profile</a></li>
            <li><a href="#">Notification</a></li>
            <li><a href="first_member.jsp">Find book</a></li>
             </form>
          </ul>
        </div>
        <div class="gadget">
