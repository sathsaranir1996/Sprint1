    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="support.html"><span><span>Sign In</span></span></a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		<div class="col-sm-10  my-col3 ">
                        <br>
                    <h1 style="text-align: center">Register librarian</h1>
                    <br>
                    <table class="table">
                        <tr>
                            <td>
                    <form style="text-align:center" action="register" method="post">
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" placeholder="Enter New Uer Name" id="input2" name="username">
                        </div>
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="password" class="form-control" placeholder="password" id="input2" name="password">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder="Full name" id="input2" name="name">
                                </div>
                          ...
                          <input type="text" class="form-control" placeholder="x----@gmail.com" id="input2" name="email">
                        </div>
								 <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Phone</span>
                          </div>
                          <input type="text" class="form-control" placeholder="+94111111111" id="input2" name="phone">
                        </div>
						 ...
						 <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" placeholder="dd/mm/year" id="input2" name="birthday">
                        </div>
						 ...
						 <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" placeholder="nic " id="input2" name="nic">
                        </div>
						 ...
						 <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" placeholder="address" id="input2" name="address">
                                ...
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton" name="st" value="libadd">Create</button>
                              </form>
                            </td>
                            </tr>
                            </table>
