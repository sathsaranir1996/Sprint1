                        ...
                        %>
	                        <form action="add_cart" method="post">
								<tr>
								  ...
								  <td><input type="hidden" name="name" value="<%=list.get(0)%>"><%=list.get(0) %></td>
								  <td><input type="hidden" name="email" value="<%=list.get(1)%>"><%=list.get(1) %></td>
								  <td><input type="hidden" name="phone" value="<%=list.get(2)%>"><%=list.get(2) %></td>
								</tr>
							</form>
						<%
								}
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="first_librarian.jsp">Search books</a></li>
            <li><a href="#">Borrowed book</a></li>
            <li><a href="Rprofile.jsp">Profile</a></li>
