                    ...
                    <form style="text-align:center" action="addbook" method="post">
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >ISBM No</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter ISBM No" id="input2" name="bookno" pattern="[A-Za-z0-9]{1,5}" title="Field can't be empty">
                        </div>
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="text" class="form-control" placeholder="Enter Book title" id="input2" name="title" pattern="[A-Za-z0-9]{1,20}" title="Field can't be empty">
                            </div>
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder=" Enter author name" id="input2" name="author" pattern="[A-Za-z0-9]{1,20}" title="Field can't be empty">
                                </div>
								
								 <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Number of copys</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter number of copys" id="input2" name="copyno" title="Field can't be empty">
                        </div>
								 <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Description</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter short description about book" id="input2" name="description" title="Field can't be empty">
                        </div>
						
								
							
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton">Add Book</button>
                              </form>
                            </td>
                            </tr>
                            </table>
